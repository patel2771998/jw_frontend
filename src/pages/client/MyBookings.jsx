...
export default function MyBookings() {
  ...
  useEffect(() => {
    ...
    api.get('/client/bookings', { params }).then(({ data }) => setBookings(data));
  }, [filter]);
  ...
  return (
    <div>
      ...
      <p className="mt-1 text-slate-600">View status of your wellness session bookings</p>
          ...
          {bookings.map((b) => (
            <div key={b.id} className="card">
              ...
              <p className="mt-2 text-slate-600">
                {b.staff.state} • {new Date(b.date).toLocaleDateString()} @ {formatTimeAMPM(b.slotTime)}
